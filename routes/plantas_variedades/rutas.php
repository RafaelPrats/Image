...
Route::get('plantas_variedades/distribuciones','PlantaController@distribuciones');
Route::post('plantas_variedades/store_distribucion','PlantaController@store_distribucion');
