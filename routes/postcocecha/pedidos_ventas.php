...
Route::get('pedidos/set_plantas_cajas_cliente', 'PedidoVentaController@set_plantas_cajas_cliente');
Route::get('pedidos/get_variedad', 'PedidoVentaController@get_variedad');
Route::post('pedidos/restaurar_recetas', 'PedidoVentaController@restaurar_recetas');
