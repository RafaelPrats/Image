...
Route::get('clasificacion_verde/monitoreo_calibres', 'ClasificacionVerdeController@monitoreo_calibres');
Route::post('clasificacion_verde/store_monitoreo_calibre', 'ClasificacionVerdeController@store_monitoreo_calibre');
Route::post('clasificacion_verde/buscar_calibre_by_fecha', 'ClasificacionVerdeController@buscar_calibre_by_fecha');
...
/* --------------------------------------------------------------------------------------------------------------------- */
Route::get('clasificacion_verde/add_new_verde', 'ClasificacionVerdeController@add_new_verde');
Route::post('clasificacion_verde/store_verde', 'ClasificacionVerdeController@store_verde');
Route::post('clasificacion_verde/update_detalle_verde', 'ClasificacionVerdeController@update_detalle_verde');
Route::post('clasificacion_verde/delete_detalle_verde', 'ClasificacionVerdeController@delete_detalle_verde');