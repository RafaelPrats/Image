<?php
    ...
    Route::get('caja_presentacion/admin_productos','CajasPresentacionesController@admin_productos');
    Route::get('caja_presentacion/buscar_productos','CajasPresentacionesController@buscar_productos');
    Route::post('caja_presentacion/store_agregar_productos','CajasPresentacionesController@store_agregar_productos');
    Route::get('caja_presentacion/buscar_detalles','CajasPresentacionesController@buscar_detalles');
