...
Route::post('sectores_modulos/update_ciclo_campo', 'CiclosController@update_ciclo_campo');
Route::post('sectores_modulos/update_all_ciclo_campo', 'CiclosController@update_all_ciclo_campo');