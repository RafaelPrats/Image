...
@section('contenido')
    ...
    <div class="login-box-body sombra_estandar" style="border-radius: 20px">
        <div class="login-logo">
            <a href="{{ url('') }}">
                <img src="{{ url('images/Logo_Bench_Flow_verde_negro.png') }}" alt="" style="width:220px">
            </a>
        </div>
        ...
        <form action="{{ url('login') }}" method="post" id="form_login">
            ...
            @endif
            <div class="text-center">
                <button type="button" id="btn_login" class="btn btn-yura_primary btn-block">Comenzar</button>
            </div>
        </form>
    </div>
@endsection
