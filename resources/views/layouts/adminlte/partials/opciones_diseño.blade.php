<div id="control-sidebar-config-tab" class="tab-pane active">
    <div id="div_manual_usuario"></div>
    <div class="hidden">
        <div class="form-group">
            <label class="control-sidebar-subheading">
                <input type="checkbox" class="pull-right" id="config_fixed_layout" onclick="set_config('')"
                    {{ getUsuario(Session::get('id_usuario'))->configuracion->fixed_layout == 'S' ? 'checked' : '' }}>
                Diseño compacto
            </label>
        ...
        <div class="form-group">
            <label class="control-sidebar-subheading">
                <input type="checkbox" class="pull-right" id="config_boxed_layout" onclick="set_config('')"
                    {{ getUsuario(Session::get('id_usuario'))->configuracion->boxed_layout == 'S' ? 'checked' : '' }}>
                Diseño en caja
            </label>
        ...
        <div class="form-group">
            <label class="control-sidebar-subheading">
                <input type="checkbox" class="pull-right" id="config_color" onclick="set_config('')"
                    {{ getUsuario(Session::get('id_usuario'))->configuracion->toggle_color_config == 'S' ? 'checked' : '' }}>
                Cambiar color del
                menú derecho
            </label>
        </div>
        <div class="form-group">
            <label class="control-sidebar-subheading">
                <input type="checkbox" class="pull-right" id="config_online" onclick="set_config('')"
                    {{ getUsuario(Session::get('id_usuario'))->configuracion->config_online == 'S' ? 'checked' : '' }}>
        ...
        <ul class="list-unstyled clearfix">
            <li style="float:left; width: 33.33333%; padding: 5px;">
                <a href="javascript:void(0)" onclick="set_config('skin-blue')"
            ...
            <li style="float:left; width: 33.33333%; padding: 5px;">
                <a href="javascript:void(0)" onclick="set_config('skin-black')"
                    style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">
            ...
            <li style="float:left; width: 33.33333%; padding: 5px;">
                <a href="javascript:void(0)" onclick="set_config('skin-purple')"
                    style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">
                    <div>
            ...
            <li style="float:left; width: 33.33333%; padding: 5px;">
                <a href="javascript:void(0)" onclick="set_config('skin-green')"
                    style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">
                    <div>
                        <span style="display:block; width: 20%; float: left; height: 7px;"
            ...
            <li style="float:left; width: 33.33333%; padding: 5px;">
                <a href="javascript:void(0)" onclick="set_config('skin-red')"
                    style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">
                    <div>
                        <span style="display:block; width: 20%; float: left; height: 7px;"
            ...
            <li style="float:left; width: 33.33333%; padding: 5px;">
                <a href="javascript:void(0)" onclick="set_config('skin-yellow')"
                    style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">
                    <div>
                        <span style="display:block; width: 20%; float: left; height: 7px;"
            ...
            <li style="float:left; width: 33.33333%; padding: 5px;">
                <a href="javascript:void(0)" onclick="set_config('skin-blue-light')"
                    style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">
                    <div>
                        <span style="display:block; width: 20%; float: left; height: 7px; background: #367fa9"></span>
            ...
            <li style="float:left; width: 33.33333%; padding: 5px;">
                <a href="javascript:void(0)" onclick="set_config('skin-red-light')"
                    style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">
                    <div>
                        <span style="display:block; width: 20%; float: left; height: 7px;"
                            class="bg-red-active"></span>
        ...
        <button type="button" class="btn btn-block btn-success" onclick="save_config()"><i
