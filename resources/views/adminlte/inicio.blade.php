...
@section('contenido')
    ...
    @if(in_array(getUsuario(Session::get('id_usuario'))->rol()->tipo, ['P', 'A']))    {{--P => rol Principal; A => Administrador--}}
    <section class="content">
        @if(count(getUsuario(Session::get('id_usuario'))->rol()->getSubmenusByTipo('C')) > 0)
            ...
            @php
                ...
                $color_18 = getColorByIndicador('C12');   //  costo_x_planta
            @endphp
                ...
                <div id="div_box_body">
                    <table style="width: 100%;" align="center" class="table-borsdered">
                        ...
                        <tr>
                            ...
                            <td colspan="4" style="border-left: 1px solid #00B388; border-bottom: 1px solid #00B388; height: 15px"></td>
                            <td colspan="4"></td>
                        </tr>
                        <tr>
                            <td colspan="4"></td>
                        ...
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="4" style="border-left: 1px solid #00B388; border-top: 1px solid #00B388; height: 15px"></td>
                            <td colspan="4" style="border-left: 1px solid #00B388; height: 15px"></td>
                            <td colspan="4" style="border-left: 1px solid #00B388; border-top: 1px solid #00B388; height: 15px"></td>
                                                ...
                                                <li>
                                                    <strong style="color:{{$color_14}}">
                                                        <strong style="color: {{$color_4}}">
                                                            <small>Precio:</small>
                                                            <span title="Tallo" style="color:{{$color_7}}">
                                                                <small>¢</small>{{round($precio_x_tallo * 100, 2)}}
                                                            </span>
                                                        </strong>
                                                    </strong>
                                                </li>
                                            ...
                                            <ul class="list-unstyled text-center">
                                                ...
                                                <li>
                                                    <strong title="Cajas exportadas">
                                                        <small>Desecho:</small> {{100 - porcentaje($tallos, $tallos_cosechados, 1)}}
                                                        %</strong>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div style="" class="td-org">
                                    <div class="row">
                                        <div class="col-md-12" style="margin-top: 10px">
                                            <ul class="list-unstyled text-center">
                                                <li>
                                                    <strong title="Costo x planta" style="color:{{$color_18}}">
                                                        <small>Costo x planta:</small>
                                                        <span id="span_costos_x_planta">¢{{number_format(round($costo_x_planta * 100, 3), 2)}}</span></strong>
                                                </li>
                                                <li>
                                        ...
                                        <div class="col-md-12" style="margin-top: 10px">
                                            <ul class="list-unstyled text-center">
                                                <li>
                                                    <strong title="Total">
                                                        <small>Total:</small>
                                                        <span id="span_costos_total">${{number_format(explode(':', $costos_mano_obra)[1] + explode(':', $costos_insumos)[1] + explode(':', $costos_fijos)[1] + explode(':', $costos_regalias)[1] + explode(':', $costos_propagacion)[1] , 2)}}</span></strong>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <strong title="Propagación, Semana: {{explode(':', $costos_propagacion)[0]}}">
                                                        <small>Propagación:</small>
                                                        <span id="span_costos_propagacion">${{number_format(explode(':', $costos_propagacion)[1] , 2)}}</span></strong>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
