    ...
    <section class="content">
        ...
        <div class="row" style="margin-top: 10px">
            ...
            <div class="col-md-4 bg-yura_dark border-radius_16" id="div_master_ranking">
                        ...
                        <ul class="dropdown-menu sombra_pequeña" style="top: 28px;">
                            <li>
                                <a href="javascript:void(0)" class="li_tipo_ranking bg-aqua-active"
                                    onclick="$('#tipo_ranking').val('P'); $('.li_tipo_ranking').removeClass('bg-aqua-active'); $(this).addClass('bg-aqua-active'); listar_ranking();">
                                    Variedades
                                </a>
                                <a href="javascript:void(0)" class="li_tipo_ranking"
                                    onclick="$('#tipo_ranking').val('V'); $('.li_tipo_ranking').removeClass('bg-aqua-active'); $(this).addClass('bg-aqua-active'); listar_ranking();">
                                    Colores
                                </a>
                            </li>
                        </ul>
                ...
                <input type="hidden" id="tipo_ranking" value="P">
