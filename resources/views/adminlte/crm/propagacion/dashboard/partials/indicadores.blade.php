    ...
    <tr>
        ...
        <td style="padding-left: 2px; padding-right: 2px">
            <div class="div_indicadores border-radius_16" style="background-color: #30BBBB; margin-bottom: 5px">
                <legend class="text-center" style="font-size: 1.1em; margin-bottom: 5px; color: white">Ptas Madres<sup>-4 semanas</sup></legend>
                <p style="color: white">Costo x Esqueje
                    <strong class="pull-right">
                        &cent;{{round($costo_x_esqueje * 100, 4)}}
                    </strong>
                </p>
                <legend style="margin-bottom: 5px; color: white"></legend>
                <p class="text-center" style="margin-bottom: 0px">
                    <a href="javascript:void(0)" class="text-center" style="color: white" onclick="desglose_indicador('costo_x_esqueje')">
                        <strong>Ver más <i class="fa fa-fw fa-arrow-circle-right"></i></strong>
                    </a>
                </p>
            </div>
        ...
        <td style="padding-left: 2px; padding-right: 2px">
            <div class="div_indicadores_md_2 border-radius_16" style="background-color: #FFFFFF; margin-bottom: 5px">
                <legend class="text-center" style="font-size: 1.1em; margin-bottom: 5px;">Enraizamiento <sup>-4 semanas</sup></legend>
                <p>% Enraizamiento
        ...
        <td style="padding-left: 2px;">
            <div class="div_indicadores_md_2 border-radius_16" style="background-color: #30BBBB; margin-bottom: 5px">
                ...
                <p style="color: white">Costo x Planta
                    <strong class="pull-right">&cent;{{$costo_x_planta * 100}}</strong>
                </p>
                <legend style="margin-bottom: 5px; color: white"></legend>
                <p class="text-center" style="margin-bottom: 0px">
