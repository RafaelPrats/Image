@if(count($ciclos) > 0)
    <div id="div_content_fixed">
        <table {{--data-order='[[ 3, "desc" ]]'--}} class="table-striped table-bordered" width="100%"
            ...
            <tr style="color: white">
                <th class="fila_fija1" style="padding-left: 5px; border-radius: 18px 0 0 0">
                    Módulo
                </th>
                <th class="fila_fija1" style="padding-left: 5px" width="95px">
                    Inicio
                </th>
                ...
                <th class="fila_fija1" style="background-color: #00B388; padding-left: 5px; border-radius: 0 18px 0 0">
                    Conteo T/P
                </th>
            </tr>
            </thead>
            ...
            @foreach($ciclos as $pos_item => $item)
                ...
                @endphp
                <tr style="font-size: 0.9em; background-color: {{$pos_item % 2 == 0 ? '#72ffe052' : ''}}">
                    <td style="border-color: #9d9d9d; padding-left: 5px">
                        <button type="button" class="btn btn-xs btn-link" style="color: black"
                                onclick="mostrar_resumen_modulo('{{$item->id_ciclo}}')">
                            {{$item->modulo->nombre}}
                        </button>
                    </td>
                    <td style="border-color: #9d9d9d; padding-left: 5px">
                    ...
                    <td style="border-color: #9d9d9d;; padding-left: 5px">
                        <a href="javascript:void(0)"
                           onclick="ver_labores_by_ciclo('{{$item->id_ciclo}}', '{{$poda_siembra == 0 ? $app_gib_siembra->id_aplicacion : $app_gib_poda->id_aplicacion}}')">
                            {{$semana->codigo}}
                        </a>
                    </td>
                    <td style="border-color: #9d9d9d; padding-left: 5px">
            ...
            <tr style="background-color: #00B388; color: white">
                ...
                <th style="background-color: #00B388; padding-left: 5px">
    ...
    <script>
        ...
        function mostrar_resumen_modulo(ciclo) {
            datos = {
                ciclo: ciclo,
            };
            get_jquery('{{url('fenograma_ejecucion/mostrar_resumen_modulo')}}', datos, function (retorno) {
                modal_view('modal-view_mostrar_resumen_modulo', retorno, '<i class="fa fa-fw fa-list"></i> Cosecha diaria',
                    true, false, '85%');
            });
        }
