        ...
        <tr>
            ...
            <td style="min-width: 220px">
                <div class="input-group">
                    ...
                    <select id="form_cliente" class="form-control" style="width: 100%"
            ...
            <tr>
                ...
                <td>
                    <div class="input-group" style="min-width: 180px">
                        ...
                        <input type="number" id="form_longitud" class="form-control text-center"
                            style="width: 100%" onchange="buscar_form_especificaciones()">
    ...
    <table style="margin-top: 0; width: 100%">
        <tr>
            <td rowspan="4" style="text-align: right; padding-right: 20px; min-width: 320px">
                <div class="btn-group">
                    <button type="button" class="btn btn-yura_primary" onclick="grabar_pedido()">
                        <i class="fa fa-fw fa-save"></i> Grabar Pedido
                    </button>
                    <button type="button" class="btn btn-yura_default" onclick="cerrar_modals(); agregar_pedido()">
...
<script>
    setTimeout(() => {
        $("#form_cliente, #form_consignatario, #form_agencia")
            .select2({
                dropdownParent: $('#div_modal-modal-view_agregar_pedido')
            });
    }, 500);
            ...
            if (!fallos) {
                ...
                BootstrapDialog.show({
                    ...
                    onshown: function(modal) {
                        ...
                        modal.setId('modal_quest_grabar_pedido');
                        arreglo_modals_form.push(modal);
                        $('#btn_no_' + 'modal_quest_grabar_pedido').addClass('btn-yura_default');
                        $('#btn_continue_' + 'modal_quest_grabar_pedido').addClass('btn-yura_primary');
                    },
                    callback: function() {
                        arreglo_modals_form = [];
                    },
                    buttons: [{
                        id: 'btn_no_' + 'modal_quest_grabar_pedido',
                        label: 'No',
                        ...
                        id: 'btn_continue_' + 'modal_quest_grabar_pedido',
                        label: 'Continuar',
                        ...
                        action: function(modal) {
                            ...
                            $.LoadingOverlay('show');
                            $.post('{{ url('pedidos/grabar_pedido') }}', datos, function(retorno) {
                                if (retorno.success) {
