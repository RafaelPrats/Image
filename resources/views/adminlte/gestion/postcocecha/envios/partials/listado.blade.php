                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            {{-- <div class="col-md-3">
                                                ...
                                                {{$factura_tercero ?  "disabled" : ""}}id="codigo_dae" name="codigo_dae" value="{{isset($envio->codigo_dae) ? $envio->codigo_dae : $codigo_dae}}"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                id="guia_madre" name="guia_madre" value="{{$envio->guia_madre}}" onkeyup="set_aerolinea(this)" onchange="set_aerolinea(this)">
                                            </div>
                                            <div class="col-md-3">
                                        ...
                                        <div class="row" >
                                            <div class="col-md-3">
                                                ...
                                                <select id="aerolinea" name="aerolinea" class="form-control"  {{($facturado) ? "disabled='disabled'" : ""}}>
                                                    @if(getEnvio($envio->id_envio)->detalles[0]->id_aerolinea == null)
                                                        <option selected disabled value="">Seleccione</option>
                                                    @endif
                                                    @foreach($aerolineas as $a)
                                                        <option {!! getEnvio($envio->id_envio)->detalles[0]->id_aerolinea ==  $a->id_aerolinea ? "selected" : ""!!} value="{{$a->codigo}}" data-id_aerolinea="{{$a->id_aerolinea}}">{{$a->nombre}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-3">
...
<script>
    ...
    function set_aerolinea(input){
        ...
        if(input.value.length>=3){
            ...
            $("select#aerolinea option").removeAttr('selected')
            $("select#aerolinea option[value='"+input.value.slice(0,3)+"']").attr('selected',true)

        }

    }

    //addEventListener("paste", myScript);
