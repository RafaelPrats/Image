<script>
    ...
    function listar_clasificacion_blanco() {
        $.LoadingOverlay('show');
        datos = {
    ...
    function ver_rendimiento(blanco) {
        ...
        get_jquery('{{ url('clasificacion_blanco/ver_rendimiento') }}', datos, function(retorno) {
            modal_view('moda-view_ver_rendimiento', retorno,
    ...
    function rendimiento_mesas() {
        ...
        $.get('{{ url('clasificacion_blanco/rendimiento_mesas') }}', datos, function(retorno) {
            modal_view('modal-view_rendimiento_mesas', retorno,
                '<i class="fa fa-fw fa-cubes"></i> Rendimiento por mesa', true, false, '99%')
        }).always(function() {
            $.LoadingOverlay('hide');
        });
    }
