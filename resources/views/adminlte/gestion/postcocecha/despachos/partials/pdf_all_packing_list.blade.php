@foreach ($listado as $pos_item => $item)
    @php
        ...
        $envios_pedido = $pedido->envios;
        $consignatario = $envios_pedido[0]->consignatario;
    @endphp

    <div style="position: relative; top: -20px; left: -30px; width: 760px">
            ...
            <tr>
                <td>
                    <table style="width:100%;font-family: arial, sans-serif;border-collapse: collapse;">
                        ...
                        <tr>
                            <td style="font-size: 11px;">CURRIER : {{ $detalles_pedido[0]->agencia_carga->nombre }}</td>
                        </tr>
                        {{-- <tr>
                    <td style="font-size: 11px;">PHONE : </td>
                        ...
                        <tr>
                            <td style="font-size: 11px;">CONSIGNEE :
                                {{ isset($envios_pedido[0]) && isset($consignatario) ? $consignatario->nombre : '' }}
                            </td>
                        </tr>
                        <tr>
                            <td style="font-size: 11px;">ADDRESS :
                                {{ isset($envios_pedido[0]) && isset($consignatario) ? $consignatario->direccion : '' }}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="font-size: 11px;">CITY COUNTRY : {{ $cliente['pais'] }}
                            </td>
                        </tr>
                    </table>
                </td>
                <td>
                    <table style="width:100%;font-family: arial, sans-serif;border-collapse: collapse;">
                        ...
                        <tr>
                            <td>M.A.W.B: {{ isset($envios_pedido[0]) ? $envios_pedido[0]->guia_madre : '' }}</td>
                        </tr>
                        <tr>
                            <td>H.A.W.B: {{ isset($envios_pedido[0]) ? $envios_pedido[0]->guia_hija : '' }}</td>
                        </tr>
                        <tr>
                            <td>AIR LINE: </td>
                        </tr>
                        <tr>
                            <td>DAE N.: {{ isset($envios_pedido[0]) ? $envios_pedido[0]->dae : '' }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table style="width:100%;font-family: arial, sans-serif;border-collapse: collapse;">
            <thead style="border: 1px solid black">
                ...
                <tr>
                    ...
                    @foreach ($datosExportacion as $de)
                        <td style="border: 1px solid black; font-size: 0.7em">{{ $de['nombre'] }}</td>
                    @endforeach
            ...
            <tbody style="border: 1px solid black">
                @php
                    ...
                    $totalRamos = 0;
                @endphp
                @foreach ($detalles_pedido as $x => $det_ped)
                    @php
