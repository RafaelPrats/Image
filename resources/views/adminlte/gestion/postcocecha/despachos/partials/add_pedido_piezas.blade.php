@foreach ($arr_pedidos as $z => $p)
    <tr id="tr_pedido_piezas" class="tr_pedido_piezas hide">
        <td class="text-center" style="vertical-align: middle; background-color: #357CA5; color: white">
            <select id="pedido_{{$cant_form}}_{{$z+1}}" name="pedido_{{$cant_form}}_{{$z+1}}"
                    class="pedido" style="color: black" onchange="obetener_piezas('{{$cant_form}}','{{$z+1}}',this)">
        ...
        <td class="text-center" style="vertical-align: middle; background-color: #357CA5; color: white">
            ...
            <div class="col-sm-10">
                <input type="number" min="0" class="caja caja_{{$cant_form}} caja_{{$cant_form}}_{{$z+1}}"
                    value="0" id="full_{{$cant_form}}_{{$z+1}}"
        ...
        <td class="text-center" style="vertical-align: middle; background-color: #357CA5; color: white">
            ...
            <div class="col-sm-10">
                <input type="number" min="0" class="caja caja_{{$cant_form}} caja_{{$cant_form}}_{{$z+1}}"
                    value="0" id="half_{{$cant_form}}_{{$z+1}}"
                    onchange="calcular_piezas('table_despacho_{{$cant_form}}')"
        ...
        <td class="text-center" style="vertical-align: middle; background-color: #357CA5; color: white">
            ...
            <div class="col-sm-10">
                <input type="number"min="0" class="caja caja_{{$cant_form}} caja_{{$cant_form}}_{{$z+1}}"
                    value="0" id="cuarto_{{$cant_form}}_{{$z+1}}"
                    onchange="calcular_piezas('table_despacho_{{$cant_form}}')"
                    onkeyup="calcular_piezas('table_despacho_{{$cant_form}}')"style="border: none;width: 84px;height: 16px;color:black" required>
            </div>
        </td>
        {{-- <td class="text-center" style="vertical-align: middle; background-color: #357CA5; color: white">
            ...
            <div class="col-sm-10">
                <input type=number" min="0"  class="caja caja_{{$cant_form}} caja_{{$cant_form}}_{{$z+1}}"
                    value="0" id="sexto_{{$cant_form}}_{{$z+1}}"
                    onchange="calcular_piezas('table_despacho_{{$cant_form}}')"
                    onkeyup="calcular_piezas('table_despacho_{{$cant_form}}')"
                    style="border: none;width: 84px;height: 16px;color:black" required>
            </div>
        ...
        <td class="text-center" style="vertical-align: middle; background-color: #357CA5; color: white">
            ...
            <div class="col-sm-10">
                <input type="number" min="0"  class="caja caja_{{$cant_form}} caja_{{$cant_form}}_{{$z+1}}"
                    value="0" id="octavo_{{$cant_form}}_{{$z+1}}"
                    onchange="calcular_piezas('table_despacho_{{$cant_form}}')"
                    onkeyup="calcular_piezas('table_despacho_{{$cant_form}}')"
                    style="border: none;width: 84px;height: 16px;color:black" required>
            </div>
        ...
        <td class="text-center" style="vertical-align: middle; background-color: #357CA5; color: white">
            <label class="control-label col-sm-2" style="padding:0"> 1/16:</label>
            <div class="col-sm-10">
                <input type="number" min="0"  class="caja caja_{{$cant_form}} caja_{{$cant_form}}_{{$z+1}}"
                    value="0" id="sb_{{$cant_form}}_{{$z+1}}"
                    onchange="calcular_piezas('table_despacho_{{$cant_form}}')"
                    onkeyup="calcular_piezas('table_despacho_{{$cant_form}}')"
                    style="border: none;width: 84px;height: 16px;color:black" required>
            </div>
        ...
        @if($z == 0)
            <td class="text-center" id="td_piezas" style="vertical-align: middle; background-color: #357CA5; color: white" colspan="2">
