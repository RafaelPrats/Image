<input type="hidden" name="id_pedidos" id="id_pedidos" value="{{ implode(',', $id_pedidos) }}">
    ...
    <div class="box-body" style="width: 100%;overflow-x: auto">
        ...
        <table width="100%" class="table-responsive table-bordered" style=" border-color: white">
            <thead>
                ...
                <th class="text-center" style="border-color: #9d9d9d; background-color: #357CA5; color: white">Pedido
                </th>
                <th class="text-center" style="border-color: #9d9d9d; background-color: #357CA5; color: white">Packing
                </th>
                <th class="text-center" style="border-color: #9d9d9d; background-color: #357CA5; color: white">Agencia
                </th>
                <th class="text-center" style="border-color: #9d9d9d; background-color: #357CA5; color: white">Cliente
                </th>
                ...
                <th class="text-center" style="border-color: #9d9d9d; background-color: #357CA5; color: white">Piezas
                </th>
                <th class="text-center" style="border-color: #9d9d9d; background-color: #357CA5; color: white">Full
                    Boxes </th>
                <th class="text-center" style="border-color: #9d9d9d; background-color: #357CA5; color: white">Half
                    Boxes</th>
                <th class="text-center" style="border-color: #9d9d9d; background-color: #357CA5; color: white">1/4 Boxes
                </th>
                {{-- <th class="text-center" style="border-color: #9d9d9d; background-color: #357CA5; color: white">1/6 Boxes </th> --}}
                <th class="text-center" style="border-color: #9d9d9d; background-color: #357CA5; color: white">1/8 Boxes
                </th>
                <th class="text-center" style="border-color: #9d9d9d; background-color: #357CA5; color: white">1/16
                    Boxes</th>
            ...
            <tbody>
                ...
                @foreach ($pedidos as $x => $pedido)
                    @php
                        ...
                        foreach ($pedido->detalles as $det_ped) {
                            if (
                                ...
                                foreach (
                                    $det_ped->cliente_especificacion->especificacion->especificacionesEmpaque
                                    as $m => $esp_emp
                                ) {
                                    ...
                                    switch (explode('|', $esp_emp->empaque->nombre)[1]) {
                                        ...
                                        case '0.0625':
                                            $sb += $det_ped->cantidad;
                                            $sb_det_esp_emp += $det_ped->cantidad;
                                            break;
                                    }
                                }
                            }
                    ...
                    @endphp
                    <tr id="tr_despachos" class="tr_despachos">
                        ...
                        <td class="text-center" style="border-color: #9d9d9d;vertical-align: middle">
                            ...
                            @endforeach
                            <input type="hidden" class="id_pedido id_pedido_{{ $x + 1 }}" name="id_pedido"
                                value="{{ $pedido->id_pedido }}">
                        </td>
                        <td class="text-center" style="border-color: #9d9d9d;vertical-align: middle">
                            {!! isset($pedido->envios[0]) && $pedido->envios[0]->consignatario != null
                                ? $pedido->envios[0]->consignatario->nombre
                                : "<span style='color:red'>Sin consginatario</span>" !!}
                        </td>
                        {{-- <td class="text-center" style="border-color: #9d9d9d;vertical-align: middle">
                            @php $caja_full = 0; @endphp
                            @foreach (getPedido($pedido->id_pedido)->detalles as $det_ped)
                                @if (!empty($det_ped->cliente_especificacion) && !empty($det_ped->cliente_especificacion->especificacion) && !empty($det_ped->cliente_especificacion->especificacion->especificacionesEmpaque))
                ...
                <tr>
                    ...
                    <td class="text-center" style="border-color: #9d9d9d;vertical-align: middle"> <span
                            id="piezas_totales">{{ $piezas_totales }}</span></td>
        ...
        <table width="100%" class="table-responsive table-bordered" style=" border-color: white;">
            <tr>
                ...
                <td class="text-center" style="border-color: #9d9d9d;vertical-align: middle">
                    <b>FULL BOXES : [<span id="full_box">{{ number_format($full, 4, '.', '') }}</span>]</b>
                </td>
                <td class="text-center" style="border-color: #9d9d9d;vertical-align: middle">
                ...
                <td class="text-center" style="border-color: #9d9d9d;vertical-align: middle">
                    <b> 1/16 BOXES : [<span id="sb_box">{{ number_format($sb, 2, '.', '') }}</span>]</b>
                </td>
                {{-- <td class="text-center"  style="border-color: #9d9d9d;vertical-align: middle">
        ...
        <table width="100%" class="table-responsive table-bordered" style=" border-color: white;">
            <tr>
                <td class="text-center" style="border-color: #9d9d9d;vertical-align: middle">
                    <label>Oficina de despacho </label><br />
                    <input type="text" id="nombre_oficina_despacho" style="text-align: center;"
                        class="form-control input-sm" name="nombre_oficina_despacho"
                        value="{{ isset($datos_responsables->resp_ofi_despacho) ? $datos_responsables->resp_ofi_despacho : getUsuario(Session::get('id_usuario'))->nombre_completo }}"
                        required>
                ...
                <td class="text-center" style="border-color: #9d9d9d;vertical-align: middle">
                    ...
                    <input type="text" id="nombre_asist_comercial" style="text-align: center"
                        class="form-control input-sm" name="nombre_asist_comercial"
                        value="{{ isset($datos_responsables->asist_comercial_ext) ? $datos_responsables->asist_comercial_ext : '' }}">
                </td>
            </tr>
            <tr>
                <td class="text-center" style="border-color: #9d9d9d;vertical-align: middle">
                    <label>Identificación</label>
                    <input type="text" id="id_oficina_despacho" style="text-align: center"
                        class="form-control input-sm" name="id_oficina_despacho"
                        value="{{ isset($datos_responsables->id_resp_ofi_despacho) ? $datos_responsables->id_resp_ofi_despacho : getUsuario(Session::get('id_usuario'))->cedula }}"
                        required>
                </td>
                ...
                <td class="text-center" style="border-color: #9d9d9d;vertical-align: middle">
                    <label>Identificación</label>
                    <input type="text" id="id_asist_comercial" style="text-align: center"
                        class="form-control input-sm" name="id_asist_comercial"
                        value="{{ isset($datos_responsables->id_asist_comrecial_ext) ? $datos_responsables->id_asist_comrecial_ext : '' }}">
                </td>
            </tr>
        </table>
    </div>
