...
<div class="text-center" style="margin-top: 5px">
    <button type="button" class="btn btn-yura_primary" onclick="store_copiar_pedido('{{ $pedido->id_pedido }}')">
...
<script>
    ...
    function store_copiar_pedido(id_ped) {
        ...
        post_jquery_m('{{ url('pedidos/store_copiar_pedido') }}', datos, function() {
