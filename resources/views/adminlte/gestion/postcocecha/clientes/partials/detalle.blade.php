<div class="row">
    <div class="col-md-8">
        <table width="100%" class="table table-responsive table-bordered sombra_estandar"
            style="border-color: #9d9d9d" id="table_content_detalles">
            <tr>
                <th class="text-center th_yura_green" style="width: 40%;">
                    Nombre completo
                </th>
    ...
    <div class="col-md-4">
        <div class="list-group">
            ...
            @if (es_server())
                <a href="javascript:void(0)" class="list-group-item list-group-item-action"
                    title="Añadir nueva información"
            ...
            @if (count(getDocumentos('detalle_cliente', $dataCliente->id_detalle_cliente)) > 0)
                <a href="javascript:void(0)" class="list-group-item list-group-item-action"
                    title="Ver información personalizada"
            ...
            <a href="javascript:void(0)" class="list-group-item list-group-item-action" title="Añadir nueva información"
                ...
                {{ es_server() ? 'Añadir' : 'Ver' }} contactos
            </a>
