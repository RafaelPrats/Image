            ...
            <tr style="background-color: #dd4b39; color: white">
                ...
                <th class="text-center table-{{getUsuario(Session::get('id_usuario'))->configuracion->skin}}" style="border-color: #9d9d9d;width:130px">
                   <label for="exportar_todos"> Exportar</label>
                    <input type="checkbox" id="exportar_todos" name="exportar_todos" checked onchange="select_exportar(this);onChangeSelection();" onclick="select_exportar(this);onChangeSelection();">
                </th>
            </tr>
            </thead>
