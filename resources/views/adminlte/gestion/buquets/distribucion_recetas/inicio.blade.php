...
@section('contenido')
    ...
    <section class="content">
        ...
        <div id="div_listado" style="margin-top: 10px; overflow-y: scroll; overflow-x: scroll; max-height: 500px">
        </div>
    </section>
...
@section('script_final')
    @include('adminlte.gestion.buquets.distribucion_recetas.script')
@endsection
