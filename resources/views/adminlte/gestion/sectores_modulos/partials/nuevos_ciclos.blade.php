    ...
    <table class="table-bordered table-striped" style="width: 100%; border: 1px solid #9d9d9d">
        ...
        @foreach($nuevos_ciclos as $pos => $item)
            <tr id="tr_nuevo_ciclo_{{$pos}}">
                ...
                <td class="text-center" style="border-color: #9d9d9d">
                    <input type="date" class="text-center input-yura_white" id="fecha_inicio_{{$pos}}" value="{{date('Y-m-d')}}"
                           style="width: 100%" required>
                </td>
                <td class="text-center" style="border-color: #9d9d9d">
                    <input type="text" class="text-center input-yura_white" id="poda_siembra_{{$pos}}" value="{{$item->tipo}}"
                           style="width: 100%" readonly>
                </td>
                <td class="text-center" style="border-color: #9d9d9d">
                    <input type="number" class="text-center input-yura_white" id="area_{{$pos}}" value="{{$item->modulo->area}}"
                           style="width: 100%">
                </td>
                <td class="text-center" style="border-color: #9d9d9d">
                    <input type="number" class="text-center input-yura_white" id="plantas_iniciales_{{$pos}}"
                           value="{{$item->plantas_iniciales}}"
                           style="width: 100%">
                </td>
                <td class="text-center" style="border-color: #9d9d9d">
                    <input type="number" class="text-center input-yura_white" id="plantas_muertas_{{$pos}}"
                           value="{{$item->plantas_muertas}}" style="width: 100%">
                </td>
                <td class="text-center" style="border-color: #9d9d9d">
                    <input type="text" class="text-center input-yura_white" id="curva_{{$pos}}" value="{{$item->curva}}" style="width: 100%">
                </td>
                <td class="text-center" style="border-color: #9d9d9d">
                    <input type="number" class="text-center input-yura_white" id="conteo_{{$pos}}" value="{{$item->tallos_planta}}"
                           style="width: 100%">
                </td>
                <td class="text-center" style="border-color: #9d9d9d">
                    <input type="number" class="text-center input-yura_white" id="semana_poda_siembra_{{$pos}}"
                           value="{{$item->semana_poda_siembra}}"
                           style="width: 100%">
                </td>
                <td class="text-center" style="border-color: #9d9d9d">
                    <input type="number" class="text-center input-yura_white" id="desecho_{{$pos}}" value="{{$item->desecho}}"
                           style="width: 100%">
                </td>
                <td class="text-center" style="border-color: #9d9d9d">
                    <select class="text-center input-yura_white" id="tipo_planta_{{$pos}}"
                            style="width: 100%">
                        <option value="S">Simple</option>
                        <option value="G">Gemela</option>
                    </select>
                </td>
                <td class="text-center" style="border-color: #9d9d9d">
