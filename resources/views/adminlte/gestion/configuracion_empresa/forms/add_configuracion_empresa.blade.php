<div>
    <form name="form_config" id="form_config" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group input-group">
                    <span class="input-group-addon" style="background-color: #e9ecef">N° Packing </span>
                    <input type="text" id="numero_packing" name="numero_packing" class="form-control"
                           minlength="1"  required
                           value="{!! isset($config_empresa->numero_packing) ? $config_empresa->numero_packing : "" !!}">
                </div>
            </div>
        </div>
        <hr/>
                                ...
                                <td>
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="30|7" id="clasificacion_unitaria_{{$key +1}}"
                                               name="clasificacion_unitaria_{{$key +1}}" class="form-control" minlength="1"
                                               maxlength="10"
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="30|7" id="clasificacion_unitaria_1" name="clasificacion_unitaria_1"
                                           class="form-control" minlength="1" maxlength="10" pattern="^([0-9])*$">
                                </div>
                            </td>
                        </tr>
                    @endif
