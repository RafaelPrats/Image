...
@section('contenido')
    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-body">
                <form id="form-datos-comercializacion" action="importar_data/importar_data_comercializacion" method="POST">
                    {!! csrf_field() !!}
                    <div class="input-group">
                        <span class="input-group-addon" style="background-color: #e9ecef">
                            Datos de comercialización
                        </span>
                        <input type="file" id="file_datos_comercializacion" name="file_datos_comercializacion"
                                required class="form-control input-group-addon"
                                accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-primary"
                                    onmouseover="$('#title_btn_upload').html('Cargar archivo')"
                                    onmouseleave="$('#title_btn_upload').html('')"
                                    onclick="importar_datos_comercializacion()">
        ...
        <div class="box box-info">
            <div class="box-body">
                <form id="form-importar_personal_activo" action="{{url('importar_data/personal_activo')}}" method="POST">
                    {!! csrf_field() !!}
                    <div class="input-group">
                        <span class="input-group-addon" style="background-color: #e9ecef">
                            Personal Activo
                        </span>
                        <input type="file" id="file_personal_activo" name="file_personal_activo" required class="form-control input-group-addon"
                               accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-primary" onclick="importar_personal_activo()">
                                <i class="fa fa-fw fa-check"></i>
                            </button>
                        </span>
                    </div>
