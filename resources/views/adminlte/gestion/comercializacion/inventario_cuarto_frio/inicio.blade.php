...
@section('contenido')
    ...
    <section class="content-header">
        <h1>
            Inventario de Cuarto Frio <b class="text-color_yura">NEW</b>
            ...
            <tr>
                ...
                <td>
                    <div class="input-group">
                        ...
                        <select name="filtro_presentacion" id="filtro_presentacion" class="form-control"
                            style="width: 100%">
                            <option value="">Todos</option>
                            @foreach ($presentaciones as $pres)
                                <option value="{{ $pres->id_empaque }}">
                                    {{ $pres->nombre }}
                                </option>
                            @endforeach
                        </select>
                        <span class="input-group-btn">
                            ...
                            <button type="button" class="btn btn-yura_primary" onclick="agregar_inventario()">
                                <i class="fa fa-fw fa-plus"></i>
                            </button>
                            <button type="button" class="btn btn-yura_default" onclick="descargar_reporte()">
...
@section('script_final')
    @include('adminlte.gestion.comercializacion.inventario_cuarto_frio.script')
@endsection
