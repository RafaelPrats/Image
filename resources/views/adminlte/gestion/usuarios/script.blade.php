            ...
            $.post('{{url('usuarios/eliminar')}}', datos, function (retorno) {
                if (retorno.success) {
                    if (retorno.estado) {
                        ...
                        mini_alerta('success', 'Se ha <strong>activado</strong> el usuario satisfactoriemente', 5000);
                    } else {
                        ...
                        mini_alerta('success', 'Se ha <strong>desactivado</strong> el usuario satisfactoriemente', 5000);
                    }
                    cerrar_modals();
                    buscar_listado();
                } else {
