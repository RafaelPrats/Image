...
@section('contenido')
    ...
    <section class="content">
        <div class="input-group">
            ...
            <select name="filtro_tipo_labor" id="filtro_tipo_labor" class="form-control" onchange="seleccionar_tipo_labor()">
            ...
            <select name="filtro_semana" id="filtro_semana" class="form-control">
                @foreach($semanas as $s)
                    <option value="{{$s->codigo}}" {{$s->codigo == $semana_actual->codigo ? 'selected' : ''}}>{{$s->codigo}}</option>
                @endforeach
            </select>
