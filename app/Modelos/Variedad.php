...
class Variedad extends Model
{
    ...
    protected $fillable = [
        ...
        'tallos_x_malla',
        'color',
        'saldo_inicial',    // saldo inicial con el que comenzara la proyeccion (ventas)
        ...
        'desecho_propag_disponibilidad',  // indica desecho en % que se utilizara en la propag (disponibilidad)
        'cant_semanas_propag',  // indica cantidad de semanas por defecto que durara un ciclo en propaga (PTAS MADRES)
    ];
    ...
    {
        return $this->hasMany('\yura\Modelos\DetalleReceta', 'id_variedad');
    }
