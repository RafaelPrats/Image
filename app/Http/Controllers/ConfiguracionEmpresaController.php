    ...
    public function store(Request $request)
    {
        $valida = Validator::make($request->all(), [
           ...
           // 'clasifi_unit_tipos' => 'required',
            ...
            'numero_packing.required'=> 'Debe colocar el código de la empresa que se usará para generar las etiquetas',
        ]);
        ...
        if (!$valida->fails()) {
            ...
            if($continuar){
                ...
                $objConfigEmpresa->cantidad_usuarios = 0;
                $objConfigEmpresa->cantidad_hectareas =0;
                ...
                $objConfigEmpresa->numero_packing = $request['numero_packing'];
