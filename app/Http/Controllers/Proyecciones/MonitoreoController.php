...
class MonitoreoController extends Controller
{
    ...
    public function guardar_monitoreo(Request $request)
    {
        ...
        if (!$valida->fails()) {
            ...
            if ($model == '') {
                $model = new Monitoreo();
                $monitoreo = Monitoreo::orderBy('id_monitoreo','desc')->first();
                $model->id_monitoreo = isset($monitoreo->id_monitoreo) ? $monitoreo->id_monitoreo + 1 : 1;
    ...
    public function store_nuevos_ingresos(Request $request)
    {
        foreach ($request->data as $pos => $item) {
            ...
            if ($ciclo != '') {
                $last_monitoreo = Monitoreo::All()->where('estado', 1)
                ...
                if ($last_monitoreo == '') {
                    ...
                    $monitoreo = Monitoreo::orderBy('id_monitoreo','desc')->first();
                    $last_monitoreo->id_monitoreo = isset($monitoreo->id_monitoreo) ? $monitoreo->id_monitoreo + 1 : 1;
                ...
                if ($request->reporte == 1)
                    ...
                    $last_monitoreo->azucar = $item['valor'];
