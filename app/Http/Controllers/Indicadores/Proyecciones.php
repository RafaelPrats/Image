...
class Proyecciones extends Controller
{
    public static function sumCajasFuturas4Semanas()
    {
        ...
        $objInidicardor = Indicador::All()->where('nombre', 'DP1')->first();
        $objInidicardor->valor = number_format($dato->cajas, 2, ".", "");
        $objInidicardor->save();
    ...
    public static function sumTallosFuturos4Semanas()
    {
        ...
        $objInidicardor = Indicador::All()->where('nombre', 'DP2')->first();
        $objInidicardor->valor = number_format($dato->tallos, 2, ".", "");
        $objInidicardor->save();
    ...
    public static function sumCajasVendidas()
    {
        ...
        $objInidicardor = Indicador::All()->where('nombre', 'DP3')->first();
        $objInidicardor->valor = number_format($dato->cajas, 2, ".", "");
        $objInidicardor->save();
        //$objInidicardor->update(['valor' => number_format($dato->cajas, 2, ".", "")]);
    }
    ...
    public static function sumDineroGeneradoVentas()
    {
        ...
        $objInidicardor = Indicador::All()->where('nombre', 'DP4')->first();
        $objInidicardor->valor = number_format($dato->valor, 2, ".", "");
        $objInidicardor->save();
    ...
    public static function sumTallosCosechadosFuturo1Semana()
    {
        ...
        $dato = ResumenSemanaCosecha::where('codigo_semana', $intervalos['primeraSemanaFutura'])
            ->select(DB::Raw('sum(tallos_proyectados) as tallos'))->first();
        $objInidicardor = Indicador::All()->where('nombre', 'DP6')->first();
        $objInidicardor->valor = number_format($dato->tallos, 2, ".", "");
        $objInidicardor->save();
        //$objInidicardor->update(['valor' => number_format($dato->tallos, 2, ".", "")]);
    }
    ...
    public static function sumCajasVendidasFuturas1Semana()
    {
        ...
        $objInidicardor = Indicador::All()->where('nombre', 'DP7')->first();
        $objInidicardor->valor = number_format($dato->cajas, 2, ".", "");
        $objInidicardor->save();
        //$objInidicardor->update(['valor' => number_format($dato->cajas, 2, ".", "")]);
    }
    ...
    public static function sumCajasCosechadasFuturas1Semana()
    {
        ...
        $objInidicardor = Indicador::All()->where('nombre', 'DP8')->first();
        $objInidicardor->valor = number_format($dato->cajas, 2, ".", "");
        $objInidicardor->save();
        //$objInidicardor->update(['valor' => number_format($dato->cajas, 2, ".", "")]);
    }
    ...
    public static function sumDineroGeneradoFuturo1Semana()
    {
        ...
        $objInidicardor = Indicador::All()->where('nombre', 'DP9')->first();
        $objInidicardor->valor = number_format($dato->valor, 2, ".", "");
        $objInidicardor->save();
        //$objInidicardor->update(['valor' => number_format($dato->valor, 2, ".", "")]);
    }
    ...
    public static function proyeccionVentaFutura3Meses($returnData = false)
    {
        ...
        if ($returnData) {
            ...
            $objInidicardor = Indicador::All()->where('nombre', 'DP5')->first();
            $objInidicardor->valor = $data['primer_mes']['mes'] . ":" . $data['primer_mes']['valor'] . "|" . $data['segundo_mes']['mes'] . ":" . $data['segundo_mes']['valor'] . "|" . $data['tercer_mes']['mes'] . ":" . $data['tercer_mes']['valor'];
            $objInidicardor->save();
