        ...
        if (!$valida->fails()) {
            ...
            foreach ($request->arrPrecios as $data) {
                ...
                if (empty($data['id_cliente_pedido_especificacion'])) {
                    ...
                    $objClientePedidoEspecificacion = ClientePedidoEspecificacion::find($data['id_cliente_pedido_especificacion']);
                    $palabra = 'Actualización';
                    $accion = 'U';
                }

                $objClientePedidoEspecificacion->id_cliente = $data['id_cliente'];
                $objClientePedidoEspecificacion->precio = $data['precio'];
