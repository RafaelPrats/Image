...
class AperturaController extends Controller
{
    ...
    public function buscar_aperturas(Request $request)    /* =========== OPTIMIZR LA CONSULTA =========*/
    {
        ...
        $listado = [];
        if ($request->variedad != '' || $request->unitaria != '') {
    ...
    public function store_mover_fecha(Request $request)
    {
        ...
        if ($new_lote == '') {
            ...
            $new_lote->id_lote_re = isset($lre->id_lote_re) ? $lre->id_lote_re + 1 : 1;
        ...
        if ($new_stock == '') {
            ...
            $new_stock->id_stock_apertura = isset($sa->id_stock_apertura) ? $sa->id_stock_apertura + 1 : 1;
