...
class AerolineaController extends Controller
{
    ...
    public function store_aerolinea(Request $request)
    {
        ...
        if (!$valida->fails()) {
            ...
            if(empty($request->id_aerolinea)){

                $objAgenciaTransporte = new Aerolinea;
                $aerolinea = Aerolinea::orderBy('id_aerolinea', 'desc')->first();
                $objAgenciaTransporte->id_aerolinea = isset($aerolinea->id_aerolinea) ? $aerolinea->id_aerolinea + 1 : 1;

            }else{

                $objAgenciaTransporte = Aerolinea::find($request->id_aerolinea);
