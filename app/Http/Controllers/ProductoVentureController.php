...
class ProductoVentureController extends Controller
{
    ...
    public function vincularProductosVenture(Request $request){
        ...
        if (!$valida->fails()) {
            ...
            $prodYuraVent = ProductoYuraVenture::orderBy('id_producto_yura_venture','desc')->first();
            $objProductoYuraVenture->id_producto_yura_venture = isset($prodYuraVent->id_producto_yura_venture) ? $prodYuraVent->id_producto_yura_venture + 1 : 1;
