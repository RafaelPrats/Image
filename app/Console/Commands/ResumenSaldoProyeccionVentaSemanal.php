    ...
    public function handle(){
        ...
        foreach ($variedades as $variedad){
            ...
            foreach ($semanas as $semana) {
                ...
                if(isset($dataResumenSaldoProyeccionVentaSemanal)){
                    ...
                    $objRspvs = ResumenSaldoProyVentaSemanal::orderBy('id_resumen_saldo_proy_venta_semanal','desc')->first();
                    $objResumenSaldoProyeccionVentaSemanal->id_resumen_saldo_proy_venta_semanal = isset($objRspvs->id_resumen_saldo_proy_venta_semanal) ? $objRspvs->id_resumen_saldo_proy_venta_semanal + 1 : 1;
                }
