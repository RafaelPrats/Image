...
class ResumenSemanaCosecha extends Command
{
    ...
    public function handle()
    {
        ...
        if ($semana_desde->codigo <= $semana_hasta->codigo) {
            $semanas = [];
            ...
            foreach ($semanas as $x => $semana) {
                foreach ($variedades as $y => $variedad) {
                    ...
                    if (!isset($resumenSemanaCosecha)) {
                        ...
                        $rc = ResumenCosecha::ordeBy('id_resumen_semana_cosecha', 'desc')->first();
                        $objResumenSemanaCosecha->id_resumen_semana_cosecha = isset($rc->id_resumen_semana_cosecha) ? $rc->id_resumen_semana_cosecha + 1 : 1;
