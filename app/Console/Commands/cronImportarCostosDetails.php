    ...
    public function handle()
    {
        ...
        foreach ($files as $nombre_archivo) {
            if (in_array($nombre_archivo, [
                'costos_I_S_details.xlsx',
                'costos_M_S_details.xlsx',
                'costos_I_I_details.xlsx',
                'costos_M_I_details.xlsx',
                'costos_I_S_details.csv',
                'costos_M_S_details.csv',
                'costos_I_I_details.csv',
                'costos_M_I_details.csv'])) {
                ...
                if ($url != '') {
                    Artisan::call('costos:importar_file_details', [
                        ...
                        'criterio' => 'V',
                        'sobreescribir' => explode('_', $nombre_archivo)[2],
                    ]);
