                    ...
                    foreach($clientes as $cliente){
                        ...
                        foreach($variedades as $variedad){
                            ...
                            if(!isset($objProyeccionVentaSemanal)){
                                ...
                                $ProyeccionVentaSemanalReal = ProyeccionVentaSemanalReal::orderBy('id_proyeccion_venta_semanal_real','desc')->first();
                                $objProySemReal->id_proyeccion_venta_semanal_real= isset($ProyeccionVentaSemanalReal->id_proyeccion_venta_semanal_real) ? $ProyeccionVentaSemanalReal->id_proyeccion_venta_semanal_real+1 : 1;
