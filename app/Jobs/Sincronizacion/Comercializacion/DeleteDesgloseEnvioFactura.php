...
class DeleteDesgloseEnvioFactura implements ShouldQueue
{
    ...
    public function handle()
    {
        if(Controller::checkPing()){
            ...
            Controller::conexion()->transaction(function() {
                ...
                Controller::objetoConsulta('desglose_envio_factura',[
            ...
            $this->fail("No hubo ping en la conexión con el servidor local cuando se intentó eliminar el desglose_envio_factura".$this->desgloseEnvioFactura->id_desglose_envio_factura."\n".$this->desgloseEnvioFactura);
